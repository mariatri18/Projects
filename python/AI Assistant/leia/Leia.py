...
def screenshot():
    ...
    img.save("Desktop") #Add whatever path do you want to save files
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if "time" in query:
            ...
            chromepath = "Program Files (x86)"    #Find where is your chrome path file
            ...
            songs_dir = "Music"  #Add the music directoyry path file
